...
const categories = [
  {
    ...
    algorithms: [
      ...
      },
      {
        id: "kmpnext",
        name: "KMPNext",
        description: "Compute the optimized failure function for Knuth-Morris-Pratt pattern matching.",
        complexity: "O(m)",
        status: "available" as const,
      },
      {
        id: "kmp",
        name: "KMP Search",
        description: "Knuth-Morris-Pratt algorithm for finding all occurrences of a pattern in text.",
        complexity: "O(n + m)",
        status: "available" as const,
      },
      {
        id: "bm-computed",
        name: "BM ComputeD",
        description: "Compute the D array (good suffix shift) for Boyer-Moore preprocessing.",
        complexity: "O(m)",
        status: "available" as const,
      },
      {
        id: "bm",
        name: "BM Search",
        description: "Boyer-Moore search using good suffix shift (D array) with right-to-left comparison.",
